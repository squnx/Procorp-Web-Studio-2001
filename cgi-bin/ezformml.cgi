...
@AUTHURLS = ('www.dev.solvotech.com','dev.solvotech.com','www.procorp.solvotech.com','procorp.solvotech.com','www.solvotechpro.com','solvotechpro.com');

$TO       = ('mousewurx@hotmail.com,ivansong@earthlink.net,isong@squnkwurks.com,lenoremohr@hotmail.com,Iyan7777@aol.com');

$SUBJECT  = 'Order Request';

$REDIRECT = '/order/confirm.html';

$SORT_TYPE = 'field';

@SORT_FIELDS = ('Name','Company','Address','Phone','Email','Package','MCLE','Design');
